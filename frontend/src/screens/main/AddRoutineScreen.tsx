...
export const AddRoutineScreen = () => {
  ...
  const [customLabel, setCustomLabel] = useState(""); // 직접 입력용
  ...
  const handleCreateRoutine = async () => {
    ...
    try {
      ...
      const todoId = await todoApi.createTodo(selectedPet.id, todoData);
      ...
      Alert.alert("등록 실패", "루틴을 등록하는 중 오류가 발생했습니다.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={commonStyles.header}>
        <View style={commonStyles.headerLeft}>
          ...
          <Text style={commonStyles.headerTitle}>새 루틴 등록</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.createButtonText}>루틴 등록하기</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
